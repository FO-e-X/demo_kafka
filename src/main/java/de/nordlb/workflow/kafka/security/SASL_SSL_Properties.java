...
public class SASL_SSL_Properties extends Security implements Properties {
  ...
  private java.util.Properties producerProperties(String bootstrapServer) {
    ...
    properties.setProperty(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServer+":"+Const.PORT_PRIMAER);

    properties.setProperty(CommonClientConfigs.SECURITY_PROTOCOL_CONFIG, SECURITY_PROTOCOL_SASL_SLL);
    properties.setProperty(SaslConfigs.SASL_MECHANISM, SECURITY_SASL_SSL_MECHANISM_SHA512);
